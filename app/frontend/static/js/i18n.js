(() => {
  ...
  const locales = {
    es: {
      ...
      "checkout.index": "Confirmación de pedido",
      "checkout.title": "Confirma tu carrito.",
      "checkout.copy": "Primero guardaremos tu pedido en la base de datos. Después verás su confirmación.",
      "checkout.name": "Nombre completo",
      "checkout.consent": "He leído y acepto el",
      "checkout.privacy": "aviso de privacidad",
      "checkout.submit": "Crear pedido",
      "checkout.submitting": "Preparando cotización…",
      "checkout.error": "No pudimos preparar esta cotización.",
      "checkout.successIndex": "Pedido guardado",
      "checkout.successTitle": "Pedido confirmado.",
      "checkout.successCopy": "Pedido {id} · total {total}. El registro se guardó correctamente.",
    ...
    en: {
      ...
      "checkout.index": "Order confirmation",
      "checkout.title": "Confirm your cart.",
      "checkout.copy": "Your order will be saved in the database before confirmation.",
      ...
      "checkout.successIndex": "Order saved",
      "checkout.successTitle": "Order confirmed.",
      "checkout.successCopy": "Order {id} · total {total}. The record was saved successfully.",
    ...
    zh: {
      ...
      "checkout.copy": "订单会先保存到数据库，然后显示确认信息。",
      "checkout.name": "姓名",
      "checkout.consent": "我已阅读并接受",
      "checkout.privacy": "隐私声明",
      "checkout.submit": "创建订单",
      "checkout.submitting": "正在生成询价…",
      "checkout.error": "无法生成此询价。",
      "checkout.successIndex": "订单已保存",
      "checkout.successTitle": "订单已确认。",
      "checkout.successCopy": "订单 {id} · 总计 {total}。记录已成功保存。",
