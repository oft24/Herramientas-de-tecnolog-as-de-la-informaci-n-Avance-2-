(() => {
  ...
  const locales = {
    es: {
      ...
      "legal.orderCopy": "El carrito crea un pedido y lo guarda en la base de datos antes de notificarlo al servicio interno. El sitio no cobra ni procesa pagos. El pedido se formaliza cuando el vendedor confirma por escrito disponibilidad, total, forma de pago y condiciones de entrega, y tú lo aceptas.",
      ...
      "legal.dataCopy": "El nombre y correo que ingreses se asocian a tu cuenta y a tus pedidos en la base de datos de la aplicación. No envíes datos bancarios o de tarjeta mediante este sitio. Las credenciales se manejan mediante sesión segura y no se guardan en el repositorio.",
      "legal.contactTitle": "Contacto y aclaraciones",
      "legal.contactCopy": "Para dudas, correcciones, cancelaciones o reclamaciones, conserva el identificador de tu pedido y utiliza los canales de contacto que se habiliten posteriormente. Conserva la confirmación escrita y el comprobante de cualquier pago.",
    ...
    en: {
      ...
      "legal.orderCopy": "The cart creates an order and stores it in the database before notifying the internal service. This site does not charge or process payments. An order is formed when the seller confirms availability, total, payment method and delivery terms in writing and you accept them.",
      ...
      "legal.dataCopy": "The name and email you provide are associated with your account and orders in the application database. Do not submit bank details or card data through this site. Credentials are handled through a secure session and are not stored in the repository.",
      "legal.contactTitle": "Contact and questions",
      "legal.contactCopy": "For questions, corrections, cancellations or complaints, keep your order identifier and use the contact channels that will be enabled later. Keep the written confirmation and proof of any payment.",
    ...
    zh: {
      ...
      "legal.orderCopy": "购物车会创建订单，并在通知内部服务前将订单保存到数据库。本网站不收费或处理付款。卖方书面确认库存、总额、付款方式和交付条件且你接受后，订单方告成立。",
      ...
      "legal.dataCopy": "你提供的姓名和电子邮件会与应用数据库中的账户和订单关联。请勿通过本网站提交银行或银行卡信息。凭据通过安全会话处理，不会保存在代码仓库中。",
      "legal.contactTitle": "联系与咨询",
      "legal.contactCopy": "如需咨询、更正、取消或投诉，请保留订单编号，并使用之后启用的联系渠道。请保留书面确认和任何付款凭证。",
